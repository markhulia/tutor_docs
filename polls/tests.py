...
def create_question(question_text, days):
    """
    Create a question with a given 'question_text' and published the given number pf 'days' offset
    to now() (negative for questions published in the past, positive for questions that have not
    yet been published).
